(function(){
  ...
  document.addEventListener("submit",e=>{const form=e.target;if(!validateBasics(form)){e.preventDefault();e.stopImmediatePropagation();form.reportValidity();}},true);
