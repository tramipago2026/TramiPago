(function(){
  ...
  function buildFooter(){
    ...
    inner.innerHTML=`
      <div class="footer-menu-grid">
        ...
        <section class="footer-menu-col"><h3>ATENCIÓN</h3><a href="contacto.html">Contacto</a><a href="#/seguimiento">Estado del trámite</a><a href="contacto.html#ayuda">Ayuda por WhatsApp</a><span>+54 9 11 6708-3232</span><span>Lun–vie 8–20 · Sáb–dom 16–20</span></section>
  ...
  addStyles();buildFooter();const enhance=()=>{buildFooter();pairEmails();tidyPayment();linkOpinion();};new MutationObserver(()=>requestAnimationFrame(enhance)).observe(document.body,{childList:true,subtree:true});window.addEventListener('error',event=>{if(event?.error) showSafeError();});window.addEventListener('unhandledrejection',()=>showSafeError());enhance();
})();